...
namespace WebAppTest.Controllers
{
    public class GamesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Developer,Genre")] Game game)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Developer,Genre")] Game game)
        {
            if (id != game.Id)
            {
                return NotFound();
